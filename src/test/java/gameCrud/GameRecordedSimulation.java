...
public class GameRecordedSimulation extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("GameRecordedSimulation")
    .exec(
      http("request_0")
        .post("/api/authenticate")
        .headers(headers_0)
        .body(RawFileBody("gameCrud/gamerecordedsimulation/0000_request.json"))
    )
    .pause(32)
    .exec(
      http("request_1")
    ...
    .exec(
      http("request_2")
        .post("/api/videogame")
        .headers(headers_2)
        .body(RawFileBody("gameCrud/gamerecordedsimulation/0002_request.json"))
    );
